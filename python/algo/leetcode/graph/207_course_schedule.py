...
if __name__ == '__main__':
    cut = Solution()
    assert True == cut.canFinish(2, [[1, 0]])
    assert False == cut.canFinish(2, [[1, 0], [0, 1]])
    assert True == cut.canFinish(4, [[2, 0], [2, 1], [3, 0], [3, 2]])
    assert False == cut.canFinish(3, [[0, 2], [1, 0], [2, 1]])
    assert True == cut.canFinish(10, [[1, 0], [2, 0], [2, 1], [3, 1], [3, 2], [4, 2], [4, 3], [5, 3], [5, 4], [6, 4],
